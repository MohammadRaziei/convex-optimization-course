...
,\beta \gamma) = \alpha F(Z,1,\alpha \beta)
	...
	برای شبیه سازی با داده های واقعی نطابق بلوک دیاگرام نشان داده شده در شکل
	\ref{fig:flowchart}
	ابتدا با شبکه Resnet بردار های ویژگی 15 تصویر بدست آمده اند. سپس از روی این بردار های ویژگی و با الگوریتم ارائه شده در این مقاله، گرافی روی این 15 گره ایجاد شده است. نتایج این کار در 
	\ref{fig:imgnet_result}
	نشان داده شده است. در این شکل بین گره های کوسه ها ارتباطات بیشتری برقرار است و همچنین بین گره های ماهی ها هم ارتباطات بیترس برقرار شده است.
	\begin{figure}[H]\label{fig:flowchart}
		\centering
	...
	\begin{figure}[H]\label{fig:imgnet_result}
		\centering
		\includegraphics[width=0.7\linewidth]{codes/results/imagenet-graph-n.pdf}
		\caption{
		نتایح دسته بندی تصاویر IMAGENET با الگوریتم یادگیری گراف
		}
		\label{fig:graph-learned-k4-1}
	\end{figure}
